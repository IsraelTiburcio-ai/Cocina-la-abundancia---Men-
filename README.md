...
- Luego valida que carguen assets críticos (`Portada.png`, `styles.css`, `script.js`, `menu-data.js` y archivos de `Menu-V2`).
...
- Reemplaza imágenes en la raíz o en `Menu-V2`.
